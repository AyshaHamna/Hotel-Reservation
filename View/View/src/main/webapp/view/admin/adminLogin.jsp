<%-- 
    Document   : adminLogin
    Created on : May 2, 2020, 2:27:45 PM
    Author     : User
--%>
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
    ...
    <html>
        ...
        <div class=Dsecond>
            <form method="POST" action="/admin-login-process"  modelAttribute="admin" onsubmit="return validateForm()" name="adminLoginForm">
        ...
        <script>
                function validateForm() {
                  var un = document.forms["adminLoginForm"]["username"].value;
                  var pw = document.forms["adminLoginForm"]["password"].value;
                  if (un === "" || pw === "") {
