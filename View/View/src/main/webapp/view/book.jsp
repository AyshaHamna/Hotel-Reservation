<%-- 
    Document   : book
    Created on : Apr 7, 2020, 11:23:33 AM
    Author     : User
--%>
    ...
    <html>
        ...
        <body bgcolor="#e8e6fe">
            ...
            <div class=transbox>
             ...
             <div class=DSecond>
                <form method="POST" action="/reservation-added" modelAttribute="book" onsubmit="return validateForm()" name="reservationForm">
                    ...
                    <input type="number" path="amount" name="amount" id="amount" placeholder="Amount" value="0" readonly><br>
                    <!--${exception}-->
