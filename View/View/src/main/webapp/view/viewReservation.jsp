<%-- 
    ...
    Created on : Apr 8, 2020, 4:17:59 PM
    Author     : User
--%>
    ...
    <html>
        ...
        <div class=DFirst>
            ...
            <div class=Dfourth><br>
                <h2>Searched Reservation</h2>
                <table>
                    <tr>
                        <td>${books.bookReferenceId}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><a href="<c:url value='/reservation-deleted/${book.bookReferenceId}'/>" >Delete</a></td>
                    </tr>
                </table>
            </div>
        </div>
